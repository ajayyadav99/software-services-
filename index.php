<?php include("header.php") ?>
    ...
    <div class="iq-banner">
      ...
      <div id="rev_slider_3_1" class="rev_slider fullwidthabanner tp-overflow-hidden" style="display:none;" data-version="5.2.6">
        ...
        <li data-index="rs-2" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="600"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
          ...
          style="z-index: 5; white-space: nowrap; font-size: 60px; line-height: 70px; font-weight: 700; color: rgba(27, 14, 61, 1.00);font-family:Nunito;">More Possibilities <br> with Ajay </h1>
          <!-- LAYER NR. 2 -->
    ...
    <div class="main-content">
      ...
      <section class="iq-works main-bg position-relative">
          ...
          <div class="row">
            <div class="col-sm-12 text-center">
              <div class="section-title">
                ...
                <h2 class="title text-white  iq-fw-8">How Does Ajay Works</h2>
              </div>
            </div>
          </div>
          <div class="row">
            <div class="col-lg-4 text-center">
              <div class="iq-workinfo">
                <div class="service-shap  mb-4 iq-rmt-40">
                  <img src="images/work/01.png" class="img-fluid " alt="">
                </div>
            ...
            <div class="col-lg-4 text-center">
              <div class="iq-workinfo">
                <div class="service-shap  mb-4 iq-rmt-40">
                  <img src="images/work/02.png" class="img-fluid " alt="">
                </div>
            ...
            <div class="col-lg-4 text-center">
              <div class="iq-workinfo">
                <div class="service-shap  mb-4 iq-rmt-40">
                  <img src="images/work/03.png" class="img-fluid " alt="">
                </div>
        ...
        <div class="iq-way">
          <img src="images/work/2.png" class="img-fluid"  alt="image">
        </div>
      </section>
      <!-- Works END -->
            ...
            <div class="col-lg-9">
              <div class="position-relative">
                ...
                <div class="video-people">
                  <div class="scrollme">
                    <img src="images/video/1.png" class="img-fluid one animateme"
                    data-when="span"
                    data-from="1"
                    data-to="0"
                  ...
                  <div class="scrollme">
                    <img src="images/video/3.png" class="img-fluid two animateme"
                    data-when="span"
                    data-from="1"
                    data-to="0"
                    data-translatex="300" alt="image">
        ...
        <div class="container">
          <div class="row flex-row-reverse">
            <div class="col-lg-6 align-self-center text-center">
              <img src="images/others/3.png" class="img-responsive img-fluid wow fadeInRight" id="img" alt="image">
            </div>
        ...
        <div class="container">
          <div class="row flex-row-reverse">
            ...
            <div class="col-lg-6 text-center wow fadeInLeft">
              <img src="images/others/2.jpg" class="img-fluid iq-rmt-40" alt="image">
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="iq-project position-relative pt-0">
        <div class="scrollme">
          <img src="images/others/13.png" class="img-fluid project-overlay-left animateme"
          data-when="enter"
          data-from="0.5"
          data-to="0"
      ...
      <section class="iq-ourclients iq-rmt-40">
        <div class="scrollme">
          <img src="images/service/1.png"  class="img-fluid service-one animateme"
          data-when="enter"
          data-from="0.5"
          data-to="0"
            ...
            <div class="col-lg-12">
              <div id="testimonial-slider" class="owl-carousel owl-theme owl-loaded iq-mt-50" data-dots="true" data-nav="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="1" data-lg-items="1" data-autoplay="true">
                <div class="testimonial-box">
                  ...
                  <h6>Nik Jorden <span><strong class="text-black">CEO -</strong><span class="iq-fw-4 ml-0"> Ajay</span></span></h6>
                </div>
                <div class="testimonial-box">
                  ...
                  <h6>Kips Leo <span><strong class="text-black">CEO -</strong><span class="iq-fw-4 ml-0"> Ajay</span></span></h6>
                </div>
                <div class="testimonial-box">
                  ...
                  <h6>Haris Morgan <span><strong class="text-black">CEO -</strong><span class="iq-fw-4 ml-0"> Ajay</span></span></h6>
                </div>
                <div class="testimonial-box">
                  ...
                  <h6>JD Scot<span><strong class="text-black">CEO -</strong><span class="iq-fw-4 ml-0"> Ajay</span></span></h6>
                </div>
                <div class="testimonial-box">
                  <img src="images/testimonials/05.jpg" class="img-fluid mb-3 img-shap " alt="">
                  <p class="description">
                    Progravida nibh vel velit auctor alinean sollicitudin, lorem quis bibendum auctor, nisi elit consequat.
                  </p>
                  <h6>Nils Wilson <span><strong class="text-black">CEO -</strong><span class="iq-fw-4 ml-0"> Ajay</span></span></h6>
                </div>
                <div class="testimonial-box">
                  <img src="images/testimonials/06.jpg" class="img-fluid mb-3 img-shap " alt="">
                  <p class="description">
                    Progravida nibh vel velit auctor alinean sollicitudin, lorem quis bibendum auctor, nisi elit consequat.
                  </p>
                  <h6>Larry Page <span><strong class="text-black">CEO -</strong><span class="iq-fw-4 ml-0"> Ajay</span></span></h6>
                </div>
                <div class="testimonial-box">
                  <img src="images/testimonials/07.jpg" class="img-fluid mb-3 img-shap " alt="">
                  <p class="description">
                    Progravida nibh vel velit auctor alinean sollicitudin, lorem quis bibendum auctor, nisi elit consequat.
                  </p>
                  <h6>Haris Morgan <span><strong class="text-black">CEO -</strong><span class="iq-fw-4 ml-0"> Ajay</span></span></h6>
          ...
          <div class="row  no-gutters ">
            <div class="col-lg-12">
              <div class=" pricing-info">
                <div class="row">
                  <div class="col-lg-2 col-sm-12"> <img src="images/pricing/1.png" class="img-fluid" alt="image"></div>
            ...
            <div class="col-lg-12">
              <div class=" pricing-info active border-top-0 border-bottom-0">
                <div class="row">
                  <div class="col-lg-2 col-sm-12"> <img src="images/pricing/2.png" class="img-fluid" alt="image"></div>
                  <div class="col-lg-7 col-sm-12 align-self-center">
                    <div class="pricing-plan">
                      <div class="section-title mb-3">
            ...
            <div class="col-lg-12">
              <div class=" pricing-info">
                <div class="row">
                  <div class="col-lg-2 col-sm-12"> <img src="images/pricing/3.png" class="img-fluid" alt="image"></div>
                  <div class="col-lg-7 col-sm-12 align-self-center">
                    <div class="pricing-plan">
                      <div class="section-title mb-3">
      ...
      <section class="iq-blogs position-relative iq-rmt-40">
                ...
                <div class="item">
                  <div class="main-blog">
                    ...
                    <div class="blog-detail">
                      ...
                      <div class="blog-info">
                        <a href="#"><img src="images/blog/clients/01.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">John Deo</span></a>
                ...
                <div class="item">
                  <div class="main-blog">
                    ...
                    <div class="blog-detail">
                      ...
                      <p class="mb-0">Progravida nibh vel velit auctor alinean sollicitudin.</p>
                      <div class="blog-info">
                        <a href="#"><img src="images/blog/clients/02.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">Kips Leo</span></a>
                        <ul class="d-inline-block float-right">
                          <li class="d-inline-block"><a href="#"><i class="far fa-thumbs-up"></i> <span class="iq-fw-8 iq-font-14">90</span></a></li>
                          <li class="d-inline-block"><a href="#"><i class="far fa-comment-alt"></i> <span class="iq-fw-8 iq-font-14">120</span></a></li>
                        </ul>
                ...
                <div class="item">
                  <div class="main-blog">
                    ...
                    <div class="blog-detail">
                      ...
                      <p class="mb-0">Progravida nibh vel velit auctor alinean sollicitudin.</p>
                      <div class="blog-info">
                        <a href="#"><img src="images/blog/clients/03.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">Glen Jax </span></a>
                        <ul class="d-inline-block float-right">
                          <li class="d-inline-block"><a href="#"><i class="far fa-thumbs-up"></i> <span class="iq-fw-8 iq-font-14">90</span></a></li>
                          <li class="d-inline-block"><a href="#"><i class="far fa-comment-alt"></i> <span class="iq-fw-8 iq-font-14">120</span></a></li>
                        </ul>
                ...
                <div class="item">
                  <div class="main-blog">
                    ...
                    <div class="blog-detail">
                      ...
                      <p class="mb-0">Progravida nibh vel velit auctor alinean sollicitudin.</p>
                      <div class="blog-info">
                        <a href="#"><img src="images/blog/clients/04.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">JD Scot</span></a>
                        <ul class="d-inline-block float-right">
                          <li class="d-inline-block"><a href="#"><i class="far fa-thumbs-up"></i> <span class="iq-fw-8 iq-font-14">90</span></a></li>
                          <li class="d-inline-block"><a href="#"><i class="far fa-comment-alt"></i> <span class="iq-fw-8 iq-font-14">120</span></a></li>
                        </ul>
                ...
                <div class="item">
                  <div class="main-blog">
                    ...
                    <div class="blog-detail">
                      ...
                      <p class="mb-0">Progravida nibh vel velit auctor alinean sollicitudin.</p>
                      <div class="blog-info">
                        <a href="#"><img src="images/blog/clients/05.jpg" class="img-fluid rounded-circle mr-3 user-img" alt="image"><span class="iq-fw-8 font-c iq-font-18">Nils Leo</span></a>
                        <ul class="d-inline-block float-right">
                          <li class="d-inline-block"><a href="#"><i class="far fa-thumbs-up"></i> <span class="iq-fw-8 iq-font-14">90</span></a></li>
                          <li class="d-inline-block"><a href="#"><i class="far fa-comment-alt"></i> <span class="iq-fw-8 iq-font-14">120</span></a></li>
                        </ul>
        ...
        <div class="scrollme">
          <img src="images/blog/05.png" class="img-fluid blog-one animateme" data-when="exit"
          data-from="0.5"
          data-to="0"
          data-translatex="50"
          alt="#">
