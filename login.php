         ...
         <div class="row no-gutters">
            <div class="col-lg-6 align-items-stretch position-relative white-bg">
               ...
               <div class="login-info">
                  ...
                  <h6>Welcome to <span class="main-color">Ajay</span> please login your account.</h6>
                  <form>
                     ...
                     <a class="slide-button button mr-3" href="login.php">
                         <div class="first">Login</div>
                         <div class="second">Login</div>
                       </a>
                       <a class="slide-button button bt-border" href="register.php">
            ...
            <div class="col-lg-6 align-self-center position-relative">
               <div class="login-right-bar h-100 text-center">
                  <img src="images/login/login.png" class="img-fluid" alt="">
               </div>
            </div>
         </div>
